...
$bgImage = null;
if (isset($backgrounds[$info->type]))
    $bgImage = $backgrounds[$info->type];
?>
<div class="container" style="background-image: url(<?= e($bgImage) ?>)">
    <div class="top-bar">
        <div class="top-bar_location">
            <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52.7624 72.774">
        ...
        <div class="top-bar_date"><?=e(date('l'))?> , <?=e(date('d'))?><sup>th</sup></div>
    </div>
    <div class="weather-info">
        ...
        $largeImage = null;
        if (isset($images[$info->type]))
            $largeImage = $images[$info->type];
        ?>
        <?php if (!empty($largeImage)): ?>
            <img class="weather-info_image" src="<?= e($largeImage) ?>" alt="<?= e($info->type) ?>">
        <?php endif; ?>
        <h2 class="weather-info_temp"><?= e($info->getCelsius()) ?><sup>o</sup>/<?= e($info->getFahrenheit()) ?><sup>o</sup></h2>
        <?php if ($info->type === 'stormy'): ?>

            <p class="weather-info_desc">
